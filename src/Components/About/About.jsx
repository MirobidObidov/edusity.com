  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            curriculum is designed to empower students with the knowledge, skills and experiences needed to excel in the dymanic field of  
            education.</p>
            ...
            <p>Wheather you aspire to become a teacher, administrator, counselor or educational leader, our diverse range of programs offers 
